      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center w-full">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8 w-full">
          {t.services.map(({ icon: Icon, text }, index) => (
            <div
              key={index}
              className="flex flex-col items-center gap-4 p-4 md:p-6 bg-white shadow-md rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl"
            >
        ...
        <div className="w-full h-full rounded-lg flex items-center justify-center overflow-hidden">
          <img 
            src={img} 
            alt="Process" 
            className="w-full h-auto md:h-full object-cover rounded-lg transition-all duration-300 ease-in-out hover:scale-105" 
          />
        </div>
      </div>
    </div>
