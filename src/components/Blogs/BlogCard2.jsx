...
const BlogCard2 = ({ image, title, description, textAlign = "left" }) => {
  return (
    <div className={`flex flex-col items-center gap-6 text-${textAlign} w-full bg-gradient-to-br from-[#4cc9f0] to-[#4361ee] rounded-xl shadow-lg p-6 sm:p-8 md:p-10 transition-transform duration-300 hover:scale-105`}>
      {/* Blog Image */}
      <img
        src={image}
        alt={title}
      ...
      {/* Blog Text */}
      <div className="w-full md:w-4/5 lg:w-3/4 text-white">
